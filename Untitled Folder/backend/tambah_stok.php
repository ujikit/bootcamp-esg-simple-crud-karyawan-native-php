...
$query_tambahStok = "update data_barang set stok_dataBarang=stok_dataBarang + '$stok_dataBarang' where id_dataBarang='$id_dataBarang'";
/*$query_tambah = "INSERT INTO jabatan_pegawai (id_jabatan, nama_jabatan,tanggal) VALUES ('sasd','asd','2016/09/09') ";*/

if (mysqli_query($connect, $query_tambahStok)){
