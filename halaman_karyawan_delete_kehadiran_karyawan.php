...
<html>
  ...
  <body>
    ...
    <div class="modal-header">
     ...
     <h4 class="modal-title">Hapus Kehadiran Karyawan</h4>
    </div>
    <form class="form-signin" action="backend/karyawan_delete_kehadiran_karyawan.php" method="post" enctype="multipart/form-data">
     <div class="modal-body">
       <div class="col-lg-12">
         <input type="hidden" class="form-control" name="id_kehadiran_karyawan" value="<?php echo $id_kehadiran_karyawan ?>" readonly>
         <p>Apakah Anda Ingin Menghapus Kepulangan Karyawan Atas Nama : &nbsp<b style="font-size:17px;"><?php echo $tampil["nama_karyawan"]  ?></b> ? </p>
       </div>
     </div>
     <div class="modal-footer">
         <button class="btn btn-success" type="submit" name="submit">Hapus Data Kehadiran</button>
     </div>
    </form>
