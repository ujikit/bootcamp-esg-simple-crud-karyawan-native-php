...
// $password_karyawan      = str_replace(' ','',$_POST['password_karyawan']);
// $password_karyawan      = password_hash($password_pegawai, PASSWORD_DEFAULT);
...
$query_ubah_pegawai  =  "UPDATE karyawan set kd_karyawan = '$kd_karyawan', nama_karyawan = '$nama_karyawan', hak_akses_karyawan = '$hak_akses_karyawan', username_karyawan = '$username_karyawan', jenis_kelamin_karyawan = '$jenis_kelamin_karyawan', jabatan_karyawan = '$jabatan_karyawan', no_hp_karyawan = '$no_hp_karyawan', alamat_karyawan = '$alamat_karyawan' where kd_karyawan='$kd_karyawan'";
...
if (mysqli_query($connect, $query_ubah_pegawai)){
